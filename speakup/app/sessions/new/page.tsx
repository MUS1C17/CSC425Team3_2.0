      ...
      <div className="flex min-h-[calc(100vh-8rem)] w-full items-center justify-center">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            <Card className="bg-card/60 border border-white/10 md:col-span-2 md:rotate-1">
              <CardHeader className="space-y-1">
                <CardTitle className="text-foreground">Choose Group</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Sessions live inside a group. Pick one to continue.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loadingGroups ? (
            ...
            <Card className="bg-card/60 border border-white/10 md:col-span-3 md:-rotate-1">
              <CardHeader className="space-y-1">
              ...
              <CardContent>
                {selectedGroupId ? (
                  <CreateSessionForm groupId={selectedGroupId} />
                ) : (
                  <div className="text-sm text-muted-foreground">Select a group to continue.</div>
                )}
              </CardContent>
            </Card>
          </div>
